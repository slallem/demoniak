...
| Provider | Examples |
|---|---|
| **OpenAI** | `_01` starter · `_02` chat · `_03` system prompt · `_04` 🔧 function calling · `_05` 📡 streaming · `_06` structured outputs · `_07` JSON mode · `_08` 👁️ vision · `_09` 👁️ vision from a URL · `_10` 🛡️ moderation · `_11` 🎛️ parameters (temperature, topP, seed, n, stop, logprobs) |
